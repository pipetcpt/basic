...
\begin{figure}
\includegraphics[width=0.9\linewidth]{./assets/media-18/image5} \caption{SIM 방법의 데이터셋의 예}\label{fig:SIM-dataset}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{./assets/media-18/image6} \caption{PPP\&D 방법의 데이터셋의 예}\label{fig:pppd}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{./assets/media-18/image8} \caption{IPP 방법의 데이터셋의 예}\label{fig:ipp-dataset-ex}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{./assets/media-18/image9} \caption{SIM 방법과 PPP\&D 방법을 쓸 때의 PK-PD 데이터셋의 예}\label{fig:sim-pppd-dataset}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/20-fig-06} \caption{Inhibition on production (Sharma and Jusko \protect\hyperlink{ref-sharma1998characteristics}{1998})}\label{fig:model-i}
\end{figure}
...
\frac{dR}{dt} \& = k\_\{in\} - k\_\{out\} \cdot R \textbackslash{}
k\_\{in\} \& \rightarrow k\_\{in\} \cdot (1 - H(t)) \textbackslash{}
H(t) \& = \frac{I_{max}\cdot C_p}{IC_{50} + C_p} ~~~(0 \textless{} I\_\{max\} \leq 1)
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/20-fig-07} \caption{Inhibition on loss (Sharma and Jusko \protect\hyperlink{ref-sharma1998characteristics}{1998})}\label{fig:model-ii}
\end{figure}
...
\frac{dR}{dt} \& = k\_\{in\} - k\_\{out\} \cdot R \textbackslash{}
k\_\{out\} \& \rightarrow k\_\{out\} \cdot (1 - H(t)) \textbackslash{}
H(t) \& = \frac{I_{max}\cdot C_p}{IC_{50} + C_p} ~~~(0 \textless{} I\_\{max\} \leq 1)
\textbackslash end\{split\}
\label{eq:model-ii}
\textbackslash end\{equation\}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/20-fig-08} \caption{Stimulation on production (Sharma and Jusko \protect\hyperlink{ref-sharma1998characteristics}{1998})}\label{fig:model-iii}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/20-fig-09} \caption{Stimulation on loss (Sharma and Jusko \protect\hyperlink{ref-sharma1998characteristics}{1998})}\label{fig:model-iv}
\end{figure}
