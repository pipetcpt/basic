...
tibble::tribble(
  ~`ADVAN subroutine`, ~`TRANS subroutine`, ~`Required parameters`,\index{TRANS}
  "ADVAN1", "TRANS1", "K",\index{ADVAN1}\index{S1}\index{TRANS}
  "ADVAN1", "TRANS2", "CL, V", # bold: \\textbf{TRANS2}\index{ADVAN1}\index{TRANS}\index{TRANS2}
  "ADVAN2", "TRANS1", "K, KA",\index{ADVAN2}\index{S1}\index{TRANS}
  "ADVAN2", "TRANS2", "CL, V, KA", # bold: \\textbf{TRANS2}\index{ADVAN2}\index{TRANS}\index{TRANS2}
  "ADVAN3", "TRANS1", "K, K12, K21",\index{ADVAN3}\index{S1}\index{TRANS}
  "ADVAN3", "TRANS3", "CL, V, Q, VSS",\index{ADVAN3}\index{SS}\index{TRANS}
  "ADVAN3", "TRANS4", "CL, V1, Q, V2", # bold: \\textbf{TRANS4}\index{ADVAN3}\index{TRANS}
  "ADVAN3", "TRANS5", "AOB, ALPHA, BETA",\index{ADVAN3}\index{TRANS}
  "ADVAN3", "TRANS6", "ALPHA, BETA, K21",\index{ADVAN3}\index{TRANS}
  "ADVAN4", "TRANS1", "K, K23, K32, KA",\index{ADVAN4}\index{S1}\index{TRANS}
  "ADVAN4", "TRANS3", "CL, V, Q, VSS, KA",\index{ADVAN4}\index{SS}\index{TRANS}
  "ADVAN4", "TRANS4", "CL, V2, Q, V3, KA", # bold: \\textbf{TRANS4}\index{ADVAN4}\index{TRANS}
  "ADVAN4", "TRANS5", "AOB, ALPHA, BETA, KA",\index{ADVAN4}\index{TRANS}
  "ADVAN4", "TRANS6", "ALPHA, BETA, K32, KA"\index{ADVAN4}\index{TRANS}
) %>% 
  kable(booktabs = TRUE, align = "l", escape = FALSE, caption = "ADVAN과 TRANS 서브루틴 조합에 따른 필수 파라미터") %>% \index{TRANS}
...
ALAGn, Absorption lag parameter for compartment n"\index{ALAG}
read_csv(txt) %>% 
  kable(booktabs= TRUE,
