...
tibble::tribble(
  ...
  kable(booktabs = TRUE, align = "l", caption = "ADVAN과 TRANS 서브루틴 조합에 따른 필수 파라미터") %>% 
...
THETA를 다르게 주어 상대생체이용률을 구할 수 있다. (코드 \@ref(exm:code-if))
