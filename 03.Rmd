...
```{r one-comp, fig.cap="(ref:one-comp)"}
knitr::include_graphics("./assets/media-03/image2.png") # 3.2
```

(ref:one-comp) 1구획 약동학 모델의 제어구문
...
```{r two-comp-pk, fig.cap = "(ref:two-comp-pk)"}
knitr::include_graphics("./assets/media-03/image4.png") # 3.3
```

(ref:two-comp-pk) 2구획 경구 약동학 모델의 \$PK 레코드
...
'(하한값, 초기 추정값, 상한값)'을 의미하며, 일반적으로 PK 파라미터는 음수인 경우가 없기 때문에, 하한값을 0으로 정의한다. 상한값을 제시하지 않으면, 10<sup>6</sup>이 기본 상한값이다.
...
```{r advan4, fig.cap = "(ref:advan4)"}
knitr::include_graphics("./assets/media-03/image6.png") # 3.5
```

(ref:advan4) 2구획 경구 약동학 모델의 제어구문의 예. ADVAN4
...
```{r advan5, fig.cap="(ref:advan5)"}
knitr::include_graphics("./assets/media-03/image7.png") # 3.6
```

(ref:advan5) 2구획 경구 약동학 모델의 제어구문의 예. ADVAN5 
...
(ref:advan6) 2구획 경구 약동학 모델의 제어구문의 예. ADVAN6
...
```{r parent-metabolite, fig.cap="(ref:parent-metabolite)"}
knitr::include_graphics("./assets/media-03/image11.png") # 3.9
```
...
```{r linear-model, fig.cap="(ref:linear-model)"}
knitr::include_graphics("./assets/media-03/image12.png") # Fig 3.10
```

(ref:linear-model) \$PRED를 이용한 간단한 선형 모델

---

다음 문헌을 참고하였다. [@kelly; @nonmem]
