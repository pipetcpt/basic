...
위 코드 \@ref(thm:one-comp)은 1구획 약동학 모델 분석을 위한 제어구문의 예이다. 위의 제어구문은 각 레코드의 정의와 사용 규칙을 이해하는데 도움이 될 것이다.
...
<!-- <table> -->
<!-- <caption>(\#tab:advan-trans) 특수 ADVAN과 그에 따른 TRANS 서브루틴</caption> -->
<!-- <tr><td>![](./assets/media-03/image3.png)</td></tr> -->
<!-- </table> -->
