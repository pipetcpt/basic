...
include_graphics("./assets/media-20/image1.png")
```
...
include_graphics("./assets/media-20/image2.png")
```
...
include_graphics("./assets/media-20/image3.png")
```
...
<!-- ```{r effect-model-code, fig.cap="(ref:effect-model-code)"} -->
<!-- include_graphics("./assets/media-20/image4.png") -->
<!-- ``` -->

(ref:effect-model-code) 효과구획 모델 코드: PREDPP Linear Model (ADVAN3, Two compartment) [@nonmem]

```{theorem, effect-model-code, echo=TRUE}
...
```{theorem, effect-comp-advan6, echo=TRUE}
...
include_graphics("./assets/media-20/image6.png")
```

(ref:direct-indirect) 직접효과와 간접효과의 모식도 [@gabrielsson]
...
include_graphics("./assets/media-20/image8.png")
```
...
include_graphics("./assets/media-20/image9.png")
```
...
include_graphics("./assets/media-20/image10.png")
```
...
include_graphics("./assets/media-20/image11.png")
```
...
include_graphics("./assets/media-20/image12.png")
```
