...
knitr::include_graphics("./assets/media-05/image1.png")
```
...
Table: (\#tab:advan-lin-property) 일반 선형 ADVAN 의 종류 및 특징 [@nonmem]
...
knitr::include_graphics("./assets/media-05/image2.png")
```
...
knitr::include_graphics("./assets/media-05/image3.png")
```
...
<table>
<caption> (\#tab:nonlin-advan) 일반 비선형 ADVAN 의 종류 및 특징 [@bonate] </caption>
<thead>
<tr class="header">
<th></th>
<th>ADVAN 6</th>
...
knitr::include_graphics("./assets/media-05/image4.png")
```
...
```{r}
knitr::include_graphics("./assets/media-05/image5.png")
```

(ref:advan5-example) 2구획 경구모델을 ADVAN5로 구현한 코드 예시

```{r}
knitr::include_graphics("./assets/media-05/image6.png")
```

(ref:advan6-example) 2구획 경구모델을 ADVAN6로 구현한 코드 예시

```{r}
knitr::include_graphics("./assets/media-05/image7.png")
```
