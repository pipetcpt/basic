...
14.1의 예제를 R로 풀이하면 다음과 같다. 우선 **nmw** package를 설치한다. [@R-nmw]
...
## Theophylline 예제 데이터셋

R에는 기본적으로 **nlme** 패키지[@R-nlme]가 설치되어 있으며, NONMEM에도 있는 theophylline 데이터가 포함되어 있다.
...
G, H는 목적함수값을 구할 때 필요하다. NONMEM에서는 **nmtran**이 G와 H를 구하는 수식을
