...
\begin{equation}
\begin{split}
\int \left\{\frac{\partial^{2}}{\partial\theta^{2}}lnf(x;\theta) + \lbrack \frac{\partial}{\partial\theta}lnf(x;\theta) \rbrack^{2} i \right\} exp(lnf(x;\theta))dx &= 0 \\
