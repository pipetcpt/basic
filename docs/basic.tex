...
\NormalTok{  CL 	=	TVCL }\OperatorTok{*}\StringTok{ }\KeywordTok{EXP}\NormalTok{(}\KeywordTok{ETA}\NormalTok{(}\DecValTok{1}\NormalTok{))}
\NormalTok{  V2 	=	TVV2 }\OperatorTok{*}\StringTok{ }\KeywordTok{EXP}\NormalTok{(}\KeywordTok{ETA}\NormalTok{(}\DecValTok{2}\NormalTok{))}
\NormalTok{  V3 	=	TVV3 }\OperatorTok{*}\StringTok{ }\KeywordTok{EXP}\NormalTok{(}\KeywordTok{ETA}\NormalTok{(}\DecValTok{3}\NormalTok{))}
\NormalTok{  Q  	=	TVQ  }\OperatorTok{*}\StringTok{ }\KeywordTok{EXP}\NormalTok{(}\KeywordTok{ETA}\NormalTok{(}\DecValTok{4}\NormalTok{))}
\NormalTok{  KA 	=	TVKA }\OperatorTok{*}\StringTok{ }\KeywordTok{EXP}\NormalTok{(}\KeywordTok{ETA}\NormalTok{(}\DecValTok{5}\NormalTok{))}
  		
\NormalTok{  ALAG1	=	}\KeywordTok{THETA}\NormalTok{(}\DecValTok{6}\NormalTok{) }\OperatorTok{*}\StringTok{ }\KeywordTok{EXP}\NormalTok{(}\KeywordTok{ETA}\NormalTok{(}\DecValTok{6}\NormalTok{))}
\NormalTok{  S2 	=	V2 }\OperatorTok{/}\StringTok{ }\DecValTok{1000}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/07-fig-01} \caption{1구획 모델의 ADVAN2, \$PRED 제어구문 파일 비교}\label{fig:first-order-pred}
\end{figure}
