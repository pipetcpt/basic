...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/01-fig-04} \caption{집단의 데이터를 처리하는 세가지 방법 A) 각자에서 얻어진 데이터, B) naive pooled method, C) two-stage method, D) mixed-effects method}\label{fig:three-ways}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/01-fig-05} \caption{측정된 체중의 분포}\label{fig:measured-weight}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/01-fig-06} \caption{혼합효과 모델링의 개념도. NONMEM 매뉴얼(Beal \protect\hyperlink{ref-nonmem}{2018})의 그림에 수식을 추가한 것}\label{fig:nonmem-figure}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/02-fig-02} \caption{Comparison between dataset for PRED and PREDPP}\label{fig:pred-predpp}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/02-fig-03} \caption{Basic example of dataset for NONMEM}\label{fig:NONMEM-dataset}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/02-fig-06} \caption{Example of dataset with noncontinuous ID arrangement (NOT appropriate)}\label{fig:id-dataset}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/02-fig-07} \caption{Example of TIME in dataset - Allowed(sequential) vs. NOT allowed(non-sequential)}\label{fig:time-dataset}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/02-fig-09} \caption{Example of AMT and RATE in dataset - drug 100mg IV infusion over 1 hr vs. 0.5 h}\label{fig:AMT-RATE}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/02-fig-10} \caption{Example of Dosing record in dataset - using TIME, AMT vs. using TIME, AMT, ADDL, II}\label{fig:dosing-dataset}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/03-fig-01} \caption{NM-TRAN 제어구문의 구성\index{NM-TRAN 제어구문 / NM-TRAN control stream}\index{NM-TRAN control stream / NM-TRAN 제어구문}\index{NM-TRAN control stream / NM-TRAN 제어구문}\index{NM-TRAN}}\label{fig:nm-tran}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/03-fig-02} \caption{모약물과 대사체의 약동학 동시 분석 모델}\label{fig:model-parent-metabolite}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/04-fig-03} \caption{Structure of 2-compartment extravascular model}\label{fig:2comp-structure}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/05-fig-01} \caption{일반 선형 ADVAN을 이용한 코드의 구조}\label{fig:advan-code}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/05-fig-03} \caption{일반 비선형 ADVAN을 이용한 코드의 구조}\label{fig:nonlin-code}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/05-fig-05} \caption{\$DES 구문 적용을 위한 코드 예시\index{\$DES}}\label{fig:des-example}
\end{figure}

\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/05-fig-06} \caption{2구획 경구모델}\label{fig:2comp-oral}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/06-fig-01} \caption{ADVAN11(위)과 ADVAN12(아래)의 모델 구조와 micro constants의 이름들}\label{fig:advan1112}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/07-fig-01} \caption{1구획 모델의 ADVAN2, \$PRED 제어구문 파일 비교\index{\$PRED}\index{ADVAN2}\index{PRED}}\label{fig:first-order-pred}
\end{figure}



\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/07-fig-02} \caption{ADVAN과 \$PRED의 데이터셋 차이\index{\$PRED}\index{PRED}}\label{fig:pred-dataset}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/08-fig-01} \caption{Newton-Raphson 방법을 이용한 함수의 최소값 추정 알고리즘의 개념도}\label{fig:newton-minimization}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/08-fig-02} \caption{복잡한 함수에서 Newton-Raphson 방법의 한계}\label{fig:limitation-newton-rhapson}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/08-fig-03} \caption{탐색적 데이터 분석을 통한 IE 값 결정}\label{fig:eda-ie}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/09-fig-01} \caption{NONMEM 추정 도식화}\label{fig:obj}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/09-fig-02} \caption{ordinary least square}\label{fig:OLS}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/09-fig-03} \caption{동전 앞면이 7회 나올 확률의 가능도}\label{fig:coin}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{assets/media-10/image1} \caption{실행결과 파일의 82-102행}\label{fig:image-01}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{assets/media-10/image5} \caption{실행결과 파일의 227행-238행}\label{fig:image-05}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./assets/media-10/image11} \caption{Basic goodness-of-fit Plots}\label{fig:basic-gof}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./assets/media-10/image12} \caption{Individual Plots}\label{fig:indi-plots}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/11-fig-01} \caption{공변량 분석의 workflow}\label{fig:workflow-covariate}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/11-fig-02} \caption{항목 평가에 필요한 잠재적 공변량 요약표}\label{fig:covariate-summary}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/11-fig-03} \caption{독립 변수의 변화에 따른 토리여과율 예측값과 실제값의 차이: 연령의 예시}\label{fig:gfr}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/11-fig-04} \caption{부적절한 데이터 분포}\label{fig:improper-distribution}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/11-fig-05} \caption{공변량 간의 상관 관계 탐색을 위한 scatterplot matrix}\label{fig:cov-scatter}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/11-fig-06} \caption{시각적 스크리닝을 위한 plot 예시}\label{fig:visual-screening}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/11-fig-07} \caption{비선형적 상관관계를 가질 가능성이 있는 경우 (Owen \protect\hyperlink{ref-kelly}{2014})}\label{fig:nonlinear-rel}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/11-fig-08} \caption{GAM에서 1개의 step을 실행한 결과}\label{fig:gam-step}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/11-fig-09} \caption{GAM 실행 summary}\label{fig:gam-summary}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/11-fig-10} \caption{임의효과로 남겨져 있는 설명 불가능한 개인차}\label{fig:unnamed-chunk-1}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/12-fig-01} \caption{모델링-시뮬레이션 workflow 및 구성 요소}\label{fig:ms-workflow}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/13-fig-01} \caption{Modeling carousel (Gabrielsson \protect\hyperlink{ref-gabrielsson}{2006})}\label{fig:carousel}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/13-fig-04} \caption{Example of Run test (Gabrielsson \protect\hyperlink{ref-gabrielsson}{2006})}\label{fig:run-test}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/13-fig-06} \caption{Schematic illustration of wrong structural models (upper row) and wrong variance models (lower row) (Gabrielsson \protect\hyperlink{ref-gabrielsson}{2006})}\label{fig:wrong-models}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./figures/13-fig-07} \caption{Example of Wrong structure model (lag time) (Gabrielsson \protect\hyperlink{ref-gabrielsson}{2006})}\label{fig:wrong-structure}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/15-fig-01} \caption{Example of EBE vs Covariates (Bonate \protect\hyperlink{ref-bonate}{2011})}\label{fig:ebe-cov}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/15-fig-04} \caption{Example 2 - Consequences of η shrinkage (Savic \protect\hyperlink{ref-uppsala}{2007})\index{shrinkage / 축소}\index{shrinkage / 축소}}\label{fig:ex2-cons}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/15-fig-05} \caption{Example 3 - Consequences of η shrinkage (Savic \protect\hyperlink{ref-uppsala}{2007})\index{shrinkage / 축소}\index{shrinkage / 축소}}\label{fig:ex3-cons}
\end{figure}



\begin{figure}
\includegraphics[width=0.95\linewidth]{./assets/media-15/image8} \caption{Induced or hidden correlation according to average shrinkage (\%) (Savic \protect\hyperlink{ref-uppsala}{2007})\index{shrinkage / 축소}\index{shrinkage / 축소}}\label{fig:induced-corr}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/15-fig-06} \caption{Example 4 - Consequences of η shrinkage (Savic \protect\hyperlink{ref-uppsala}{2007})\index{shrinkage / 축소}\index{shrinkage / 축소}}\label{fig:ex4-cons}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/15-fig-08} \caption{Perfect fit phenomenon (Savic \protect\hyperlink{ref-uppsala}{2007})}\label{fig:perfect-fit}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/15-fig-09} \caption{1-compartment model fitted to data simulated with a 2-compartment model (Savic \protect\hyperlink{ref-uppsala}{2007})}\label{fig:1comp-2comp}
\end{figure}



\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/15-fig-10} \caption{Linear Emax model fitted to data simulated with a sigmoidal Emax model (Savic \protect\hyperlink{ref-uppsala}{2007})}\label{fig:linear-sigmoidal}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/15-fig-11} \caption{Low power of IWRES to diagnose Residual error misspecification (Savic \protect\hyperlink{ref-uppsala}{2007})\index{IWRES}\index{RES}\index{WRES}}\label{fig:low-IWRES}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/16-fig-01} \caption{붓스트랩을 사용하여 여러 파라미터의 중앙값과 95\% 신뢰구간을 계산하는 방법에 대한 모식도\index{붓스트랩 / bootstrapping}\index{bootstrapping / 붓스트랩}}\label{fig:boot95}
\end{figure}



\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/16-fig-02} \caption{붓스트랩에 의해 얻어진 결과를 정리하는 방법의 예. 중앙값(95\% 신뢰구간)을 열로 정리하였고 1000개의 재추출된 데이터셋이 사용되었음을 알 수 있음\index{붓스트랩 / bootstrapping}\index{bootstrapping / 붓스트랩}}\label{fig:bootstrap-table}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/16-fig-03} \caption{사후 예측 점검의 예. 시뮬레이션된 Cmax의 분포에서 관찰값(검정색 실선)의 위치를 파악할 수 있음\index{시뮬레이션 / simulation}\index{simulation / 시뮬레이션}}\label{fig:ppc}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/16-fig-04} \caption{시각적 예측 점검 과정의 대표적인 scatter VPC 의 예 (Harling \protect\hyperlink{ref-vpcnpc}{2018}). 점선은 시뮬레이션 값들의 5, 95 퍼센타일, 실선은 중앙값을 나타냄\index{시각적 예측 점검(VPC) / visual predictive check(VPC)}\index{시뮬레이션 / simulation}\index{simulation / 시뮬레이션}\index{visual predictive check(VPC) / 시각적 예측 점검(VPC)}}\label{fig:scatter-vpc}
\end{figure}



\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/16-fig-05} \caption{신뢰구간 VPC의 예 (Confidence interval VPC). 시뮬레이션된 예측값의 5번째 백분위수와 95번째 백분위수에 대한 95\% 신뢰구간이 파란색 띠로 나타나 있고, 붉은색 점선은 관찰값의 5번쨰, 95번째 백분위수를 나타내며 붉은색 실선은 관찰값의 50번째 백분위수임\index{시뮬레이션 / simulation}\index{simulation / 시뮬레이션}}\label{fig:ci-vpc}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/16-fig-06} \caption{관찰일(DAY)에 따라 층화(stratification)가 이루어진 VPC.}\label{fig:strat-vpc}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/16-fig-07} \caption{수치로 모델의 예측성능을 평가하는 수치적 예측 점검 과정(NPC)\index{수치적 예측 점검(NPC) / numerical predictive check(NPC)}\index{numerical predictive check(NPC) / 수치적 예측 점검(NPC)}}\label{fig:npc}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/17-fig-01} \caption{용량-노출, 노출-약효의 상관관계}\label{fig:unnamed-chunk-3}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/17-fig-03} \caption{혈장약물농도와 약효의 시간적 관계 (Primary Psychiatry \protect\hyperlink{ref-dementia}{2013})}\label{fig:conc-hysteresis}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/18-fig-01} \caption{PK-PD의 연결고리}\label{fig:pkpd-link}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/18-fig-02} \caption{Clopidogrel의 PK-PD 모델 구조 (Lee et al. \protect\hyperlink{ref-lee2012population}{2012})}\label{fig:clopidogrel}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/18-fig-03} \caption{PK-PD 연결 방법과 그에 관련된 정보의 수준}\label{fig:level-info}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/18-fig-11} \caption{순차적 방법과 SIM 방법 쓸 때의 절약되는 시간 비교 (N=200) (Zhang, Beal, and Sheiner \protect\hyperlink{ref-zhang1}{2003}\protect\hyperlink{ref-zhang1}{a})}\label{fig:time-comparison}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/18-fig-12} \caption{Average absolute (A) and signed error (B) of PD parameter estimates (Zhang, Beal, and Sheiner \protect\hyperlink{ref-zhang1}{2003}\protect\hyperlink{ref-zhang1}{a})}\label{fig:absolute-signed}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./assets/media-19/image2} \caption{로그-선형 모델 (dots: 관찰값, line: 선형로그모델의 예측값, dotted line: Emax모델의 예측값)}\label{fig:log-linear-model}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./assets/media-19/image5} \caption{Emax model (좌)선형농도, (우)로그농도}\label{fig:emax-model}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/19-fig-04} \caption{E\textsubscript{max} 모델의 비교 (좌) \(E \approx E_{0} + \frac{\ E_{\max}\lbrack C\rbrack}{EC_{50} + \lbrack C\rbrack}\) (우) \(E \approx E_{0} \cdot (1 + \frac{\ E_{\max}\left\lbrack C \right\rbrack}{EC_{50} + \left\lbrack C \right\rbrack})\)}\label{fig:emax-comparison}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{./assets/media-19/image7} \caption{길항제의 E\textsubscript{max} 모델}\label{fig:anta-emax}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/19-fig-06} \caption{Sigmoid E\textsubscript{max} model. H에 따른 E\textsubscript{max} model의 형태 변화}\label{fig:sigmoid-emax}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/19-fig-07} \caption{일반적인 I\textsubscript{max} model(빨강)과 sigmoid I\textsubscript{max} model(파랑)의 비교}\label{fig:sigmoid-imax}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/19-fig-08} \caption{K\textsubscript{2}의 변화에 따른 약물농도-약효와의 관계}\label{fig:K2}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/20-fig-01} \caption{PK와 PD의 관련성 (Gabrielsson \protect\hyperlink{ref-gabrielsson}{2006})}\label{fig:pkpd-relationship}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/20-fig-02} \caption{히스테레시스(반시계방향 히스테레시스)와 프로테레시스(시계방향 히스테레시스)}\label{fig:hys-proteresis}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/20-fig-03} \caption{효과구획의 도식 (C: plasma concentration (Actually observed), Ce: effect compartment concentration (NOT observed, produced), R: response (Actually observed) (Gabrielsson \protect\hyperlink{ref-gabrielsson}{2006})}\label{fig:effect-comp}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/20-fig-04} \caption{직접효과와 간접효과의 모식도 (Gabrielsson \protect\hyperlink{ref-gabrielsson}{2006})\index{직접 효과 모델 / direct-effect model}\index{direct-effect model / 직접 효과 모델}}\label{fig:direct-indirect}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{figures/20-fig-05} \caption{Turnover 모델(간접효과 모델)의 네 가지 (Sharma and Jusko \protect\hyperlink{ref-sharma1998characteristics}{1998})}\label{fig:turnover-4}
\end{figure}
