...
\centering
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{1.8cm}>{\raggedright\arraybackslash}p{2.0cm}>{\raggedright\arraybackslash}p{1.0cm}>{\raggedright\arraybackslash}p{8.0cm}}
\toprule
...
\multirow[t]{-5}{1.8cm}{\raggedright\arraybackslash ADVAN1} & \multirow[t]{-5}{2.0cm}{\raggedright\arraybackslash 1 = Central, 2 = Output} & F0 & Output Fraction\\
\cmidrule{1-4}
...
\multirow[t]{-8}{1.8cm}{\raggedright\arraybackslash ADVAN2} & \multirow[t]{-8}{2.0cm}{\raggedright\arraybackslash 1 = Depot, 2 = Central, 3 = Output} & F0 & Output Fraction\\
\cmidrule{1-4}
 &  & K & Rate constant of elimination\\
...
\multirow[t]{-9}{1.8cm}{\raggedright\arraybackslash ADVAN3} & \multirow[t]{-9}{2.0cm}{\raggedright\arraybackslash 1 = Depot, 2 = Peripheral, 3 = Output} & F0 & Output Fraction\\
\cmidrule{1-4}
 &  & KA & Absorption rate constant\\
...
\multirow[t]{-12}{1.8cm}{\raggedright\arraybackslash ADVAN4} & \multirow[t]{-12}{2.0cm}{\raggedright\arraybackslash 1 = Depot, 2= Central, 3 = Peripheral, 4 = Output} & F0 & Output Fractlon\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}
\includegraphics[width=1\linewidth]{./figures/05-fig-02-redraw} \caption{일반 선형 ADVAN을 이용한 코드 예시}\label{fig:advan-example}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{./figures/05-fig-04-redraw} \caption{일반 비선형 ADVAN을 이용한 코드 예시}\label{fig:nonlin-advan-code-example}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{assets/media-10/image1} \caption{실행결과 파일의 82-102행}\label{fig:image-01}
\end{figure}

\begin{figure}
\includegraphics[width=0.95\linewidth]{assets/media-10/image2} \caption{실행결과 파일의 103행-137행}\label{fig:image-02}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth]{assets/media-10/image3} \caption{실행결과 파일의 138행-164행}\label{fig:image-03}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{assets/media-10/image4} \caption{실행결과 파일의 185행-212행}\label{fig:image-04}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{assets/media-10/image5} \caption{실행결과 파일의 227행-238행}\label{fig:image-05}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth]{assets/media-10/image6} \caption{실행결과 파일의 271행-290행}\label{fig:image-06}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{assets/media-10/image7} \caption{실행결과 파일의 292행-311행}\label{fig:image-07}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{assets/media-10/image7} \caption{실행결과 파일의 333행-361행}\label{fig:image-08}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth]{assets/media-10/image7} \caption{실행결과 파일의 365행-393행}\label{fig:image-09}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{./assets/media-18/image7} \caption{Example of dataset for PPP}\label{fig:PPP-dataset}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{figures/19-fig-01} \caption{선형 PD 모델 (dots: 관찰값, line: 예측값)}\label{fig:linear-pd}
\end{figure}
