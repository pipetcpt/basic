...
모델을 수치적, 시각적, 통계적으로 평가하는 다양한 방법들이 제시되어 있으며 [@pmid17328581], 이것을 표 1에서 목적과 표현방식에 따라
...
(ref:scatter-vpc) 시각적 예측 점검 과정의 대표적인 scatter VPC 의 예 \[5\]. 점선은 시뮬레이션 값들의 5, 95 퍼센타일, 실선은 중앙값을 나타냄
...
6. Nordgren RU, S;. NPC/VPC user guide Perl-speaks-NONMEM 490 2018.
