...
```{r pkpd-modeling-concept, fig.cap = "PK-PD 모델링의 개념 [@derendorf1999modeling]", out.width="100%"}
knitr::include_graphics('assets/01-fig-01.jpg')
```
...
knitr::include_graphics('assets/01-fig-02.png')
```
...
```{r diverse-concepts, fig.cap = "PK-PD 모델링의 각종 개념들의 연관성 [@helmlinger2017drug]", out.width="100%"}
knitr::include_graphics('assets/01-fig-03.png')
```
...
```{r three-ways, fig.cap="집단의 데이터를 처리하는 세가지 방법 A) 각자에서 얻어진 데이터, B) naive pooled method, C) two-stage method, D) mixed-effects method"}
knitr::include_graphics("assets/01-fig-04.png")
```
