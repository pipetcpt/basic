...
![](./assets/media-18/image1.png)

**그림1. PK-PD의 연결고리**

**6.2 PD 데이터 및 PD 모델의 특징**
...
![](./assets/media-18/image2.png)

**그림 2. Clopidogrel의 PK-PD 모델 구조 \[4\]**
...
![](./assets/media-18/image4.png)

**그림 3. PK-PD 연결 방법과 그에 관련된 정보의 수준**

**6.5. 직접효과 PK-PD 모델의 예(Examples of direct effect PK-PD model)**

**6.5.1. 동시적합법(SIM, Simultaneous fitting)**
...
![](./assets/media-18/image5.png)

**그림 4. SIM 방법의 데이터셋의 예**
...
**6.5.2. 순차적합법 (Sequential fitting)**

**6.5.2.1. PPP\&D (Population PK Parameters & Data)**
...
$THETA, $OMEGA, $SIGMA 블록 내의 θ1<sub>CL</sub>, θ<sub>V1</sub>,
ω<sub>CL</sub><sup>2</sup>, ω<sub>V1</sub><sup>2</sup>그리고
σ<sub>1</sub><sup>2</sup>에 해당한다(그림 7).

![](./assets/media-18/image6.png)

**그림 6. PPP\&D 방법의 데이터셋의 예**
...
**6.5.2.2. PPP (Population PK Parameters)**

PPP로 PK-PD 모델링 수행 시 PPP\&D 와 마찬가지로 PK 모델을 통해 얻어진 집단 PK 파라미터 추정치를 고정하여
진행한다. 이는 $THETA, $OMEGA 블록 내의 θ1<sub>CL</sub>, θ<sub>V1</sub>,
ω<sub>CL</sub><sup>2</sup>, ω<sub>V1</sub><sup>2</sup>에 해당한다.
...
**6.5.2.3. IPP (Individual PK Parameters)**
...
![](./assets/media-18/image8.png)

**그림 10. IPP 방법의 데이터셋의 예**
...
**그림 11. IPP 방법의 제어구문의 예**

**6.6 간접효과 PK-PD 모델의 예 (Examples of PK-PD model with Indirect
response)**

**6.6.1 SIM과 PPP\&D 데이터셋 및 제어구문**
...
![](./assets/media-18/image9.png)

**그림 12. SIM 방법과 PPP\&D 방법을 쓸 때의 PK-PD 데이터셋의 예**
...
![](./assets/media-18/image10.png)

**그림 13. SIM 방법과 PPP\&D 방법 쓸 때 제어구문의 공통된 부분**

**6.6.2 PPP의 데이터셋 및 제어구문**
...
데이터셋으로 변형하여 사용할 수 있다. 이는 $DATA 제어구문내의 ‘ignore’이라는 명령어를 사용하여 CMT
2에 해당하는 PK 데이터를 받아들이지 않고, 그 외의 정보(용량 정보 및 PD 데이터)만을 받아들이게 할 수 있다($DATA
...
![](./assets/media-18/image13.png)

**그림 14. PPP 방법 쓸 때의 PK-PD 데이터셋의 기본 구조**

**6.6.3 IPP의 데이터셋 및 제어구문**
...
![](./assets/media-18/image14.png)

**그림 15. IPP 방법 쓸 때의 PK-PD 데이터셋의 기본 구조**

![](./assets/media-18/image15.png)**그림 16. IPP 방법의 제어구문의 예**

**6.7 PK-PD 연결방법(적합법) 비교**
...
![](./assets/media-18/image17.png)

**그림 17. 순차적 방법과 SIM 방법 쓸 때의 절약되는 시간 비교 (N=200) \[5\]**
...
![](./assets/media-18/image18.png)

**그림 18. Average absolute (A) and signed error (B) of PD parameter
estimates \[5\]**

**6.7 PK-PD 연결방법(적합법) 요약 및 결론**
