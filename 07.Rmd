...
**Coding of control stream NOT using ADVANs**
...
knitr::include_graphics("./assets/media-07/image1.png")
```

(ref:pred-dataset) ADVAN과 \$PRED의 데이터셋 차이

```{r pred-dataset, fig.cap="(ref:pred-dataset)"}
knitr::include_graphics("./assets/media-07/image2.png")
```
...
```{r pred-formula, fig.cap="(ref:pred-formula)"}
knitr::include_graphics("./assets/media-07/image3.png")
```

(ref:pred-formula) 약력학 모델과 같이 다양한 수식들을 써야 하는 경우 ADVAN 보다는 \$PRED 블록 안에서 수식을 직접 적어주는 것이 편리하다.
