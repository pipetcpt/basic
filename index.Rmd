...
#geometry: "a5paper, nohead, nomarginpar"
...
#  ifelse(options$size != "large", paste0("\n \\", options$size,"\n\n", x, "\n\n \\large"), x)
...
`r if (is_html_output()) '2020년 여름 성의교정 연구실에서<br>대표저자 임동석 拜' else 'include_graphics("images/preface.pdf")'`

`r if (is_html_output()) '---'`

`r if (is_html_output()) '인용한 그림은 모두 새로 그렸고, 출처를 명시하였습니다.  <br>본 도서는 [부크크(bookk.co.kr)](http://www.bookk.co.kr/book/view/84646), 알라딘(aladin.co.kr), YES24(yes24.com)에서 "계량약리학 워크샵"으로 검색하여 구입할 수 있습니다.'`
